...
Students will receive an email the week of 8/29 from the community they have been assigned to with a link to schedule a[ move-in appointment.](https://housing.ucsc.edu/move-in/index.html)

### What if I can’t move-in on the specific date I was given?

You can sign up for alternative days using the appointment link that was emailed to you from your community. Please contact your [Housing Coordinator](https://housing.ucsc.edu/contact/index.html#housing) if you are unable to move in during the alternate days and times available through the move-in appointment link.
...
Testing 24 hours **_before_** you come to campus is required with either an at-home rapid antigen test or a PCR test**. Please do not come to campus if you test positive or are symptomatic. Instead, please contact your [Housing Coordinator](https://housing.ucsc.edu/contact/index.html#housing) to reschedule your move-in date and [follow these instructions from Student Health Services. ](https://healthcenter.ucsc.edu/services/covid-19/images-pdfs/covid_positive_directions_students.pdf)**

**_After_** you arrive, you will need [to take a PCR test](https://healthcenter.ucsc.edu/services/covid-19/covid19-students.html) within a week. It’s super easy, and no appointment is necessary! You will be given a PCR test kit when you receive your keys during move-in

### I’m a student living off campus. What are my testing requirements?

Testing 24 hours **_before_** you come to campus is required with either an at-home rapid antigen test or a PCR test. **Please do not come to campus if you test positive.** **[Please follow these instructions from Student Health Services.](https://healthcenter.ucsc.edu/services/covid-19/images-pdfs/covid_positive_directions_students.pdf)**

**_After_** you arrive, **you will also be required[ to take a PCR test](https://healthcenter.ucsc.edu/services/covid-19/covid19-students.html) within a week.** When you arrive on campus, please [pick up a PCR test kit. ](https://healthcenter.ucsc.edu/services/covid-19/covid19-students.html)Kits are available at the College Housing Offices, Bay Tree Campus Store, McHenry Library, or the Science and Engineering Library.
...
### I tested positive for COVID-19, and I’m on campus. What should I do?
 ...
 If you test positive and are on campus, immediately isolate and follow the [COVID-19 Positive Test Result Instructions](https://healthcenter.ucsc.edu/services/covid-19/images-pdfs/covid_positive_directions_students.pdf). 


### I tested positive for COVID-19, and I’m away from campus. What should I do?

**If you test positive, please do not come to campus.** Immediately isolate, and follow the [COVID-19 Positive Test Result Instructions](https://healthcenter.ucsc.edu/services/covid-19/images-pdfs/covid_positive_directions_students.pdf). 
...
The [UC Vaccination Policy](https://policy.ucop.edu/doc/5000695/SARS-CoV-2_Covid-19) for COVID-19 remains in effect. If you are new to campus, you must enter your vaccination dates and upload your COVID-19 vaccination card. If you do not upload proof of vaccination or show proof of filing a request for an exception, you will not be in compliance with the [Policy](https://policy.ucop.edu/doc/5000695/SARS-CoV-2_Covid-19). All students (both undergraduate and graduate) are required to adhere to the UC Vaccination Policy. **Students may be referred to student conduct (or to Staff HR as an employee) for non-compliance with university policy.**


### Am I required to get a flu shot this year?

The University of California issued an [executive order](https://ucnet.universityofcalifornia.edu/news/2021/10/2021-22-flu-vaccination-executive-order.pdf) in Fall 2021 requiring flu vaccination for all students, faculty, other academic appointees, and staff who learn, live, or work at a UC location. Vaccination against influenza is an essential measure in protecting the health of our communities based on a review of guidance from public health authorities and scientific studies, as well as consultation with UC experts.  
...
* Individuals in a [Tier I or Tier II high-risk priority group](https://www.cdph.ca.gov/Programs/CID/DCDC/Pages/Considerations-for-Expanded-Monkeypox-Post-Exposure-Prophylaxis.aspx#msdynttrid=2qvszz9jxcc4f0b46gPkGI5DVrYbLp9UPinNHBuFIB4) as defined by the California Department of Public Health. 
...
Students with questions or concerns about their MPX risk, [symptoms](https://www.cdc.gov/poxvirus/monkeypox/symptoms.html), exposure, or testing, are advised to contact Student Health Services via [Health e-Messenger:](https://studenthealth.ucsc.edu/) click Messages > New Message > Monkeypox Disease Questions. Or [Health e-Messenger](https://studenthealth.ucsc.edu/) - questions about eligibility for the Monkeypox vaccine: click Messages > New Message > Monkeypox Vaccine Eligibility Questionnaire or call the Nurse Advice Line: (831) 459-2591.
...
The university is continuing to provide free masks to the campus community. They can be picked up at the [following locations.](https://ehs.ucsc.edu/programs/safety-ih/covid-resources.html)
